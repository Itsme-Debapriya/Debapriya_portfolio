    ...
    <>
      ...
      <section className="max-container">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            Motivated and detail-oriented IT professional with practical
            experience in frontend and software development. Skilled in multiple
            Web Development Languages such as HTML, CSS, JavaScript, SCSS, MERN
            Stack. Seeking a dynamic role where I can leverage my technical
            expertise and passion for continuous learning to contribute to
            impactful and forward-thinking technology solutions.
          </p>
        </div>
